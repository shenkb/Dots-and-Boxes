//file: player*.java
//authors: Yuezhen Chen & Kaining Shen
//date: May 2, 2018
...
//      if it is a closed double, just take them
  ...
  // dealing with two box, which we call this func and the return line
  // will create a six side marked two linked boxes. 
  // force the opponent to take the two boxes
  ...
  // return the set of square that are closed double 
  // which are six side marked linked two boxes
